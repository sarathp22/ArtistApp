...
export class ShopSigninComponent implements OnInit {
 ...
 errData;
  ...
  onSubmit()
  {
    ...
    this._shop.shopLogin(this.shop).subscribe((data)=>{this.serverData=data,this.userSave(data),this._router.navigate(['/artist/workupload']);},(err)=>{if(err){this.errData=err}})
